        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="mb-10 sm:mb-16 animate-fade-in-up pt-12 lg:pt-0">
            <div className="relative">
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-green-500/20 via-emerald-500/20 to-cyan-500/20 rounded-3xl blur-2xl opacity-50 animate-pulse pointer-events-none" 
                   style={{ animationDuration: '4s' }} />
              <div className="relative">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight mb-3">
                  <span className="bg-gradient-to-r from-green-400 via-emerald-400 to-cyan-500 bg-clip-text text-transparent">Study Analytics</span>
                </h1>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.15s', animationFillMode: 'backwards' }}>
            <div className="relative group">
              {/* Outer glow effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-green-500/30 to-emerald-500/30 rounded-3xl blur-2xl opacity-60 group-hover:opacity-100 transition-all duration-500 pointer-events-none" />
              
              {/* Main glass card */}
              <div className="relative bg-gradient-to-br from-green-500/10 via-emerald-500/10 to-cyan-500/5 rounded-3xl border-2 border-green-400/30 backdrop-blur-2xl p-8 sm:p-10 transition-all duration-500 group-hover:border-green-400/50 group-hover:shadow-2xl group-hover:shadow-green-500/25">
                ...
                <div className="relative text-center py-12 sm:py-20">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Analytics Coming Soon</h2>
                  <p className="text-gray-300 text-base sm:text-lg max-w-2xl mx-auto">
                    Visualize your study time, track performance trends, and identify areas 
                    for improvement with detailed analytics. This feature is currently under development.
                  </p>
                </div>
              </div>
            </div>
