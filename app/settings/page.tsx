        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="mb-10 sm:mb-16 animate-fade-in-up pt-12 lg:pt-0">
            <div className="relative">
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-orange-500/20 via-yellow-500/20 to-red-500/20 rounded-3xl blur-2xl opacity-50 animate-pulse pointer-events-none" 
                   style={{ animationDuration: '4s' }} />
              <div className="relative">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight mb-3">
                  <span className="bg-gradient-to-r from-orange-400 via-yellow-400 to-red-500 bg-clip-text text-transparent">Settings</span>
                </h1>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '0.15s', animationFillMode: 'backwards' }}>
            <div className="relative group">
              {/* Outer glow effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/30 to-red-500/30 rounded-3xl blur-2xl opacity-60 group-hover:opacity-100 transition-all duration-500 pointer-events-none" />
              
              {/* Main glass card */}
              <div className="relative bg-gradient-to-br from-orange-500/10 via-yellow-500/10 to-red-500/5 rounded-3xl border-2 border-orange-400/30 backdrop-blur-2xl p-8 sm:p-10 transition-all duration-500 group-hover:border-orange-400/50 group-hover:shadow-2xl group-hover:shadow-orange-500/25">
                ...
                <div className="relative text-center py-12 sm:py-20">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Settings Coming Soon</h2>
                  <p className="text-gray-300 text-base sm:text-lg max-w-2xl mx-auto">
                    Personalize your account preferences, notifications, themes, and more. 
